...
$url = new moodle_url('/grade/report/audit/quickedit_item.php', array('id'=>$courseid, 'itemid'=>$itemid));
if ($page !== 0) {
    $url->param('page', $page);
}
if ($perpage !== 0) {
...
$report = new grade_report_audit($courseid, $gpr, $context, $page);
...
$reportname = get_string('quickedititem', 'gradereport_audit', $a);
print_grade_page_head($COURSE->id, 'report', 'audit', $reportname);
