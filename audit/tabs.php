...
// along with Moodle.  If not, see <http://www.gnu.org/licenses/>.
    ...
    $row[] = new tabobject('auditreport',
                           $CFG->wwwroot.'/grade/report/audit/index.php?id='.$courseid,
                           get_string('pluginname', 'gradereport_audit'));
    if (has_capability('moodle/grade:manage',$tabcontext ) ||
        has_capability('moodle/grade:edit', $tabcontext) ||
        has_capability('gradereport/audit:view', $tabcontext)) {
        $row[] = new tabobject('preferences',
                               $CFG->wwwroot.'/grade/report/audit/preferences.php?id='.$courseid,
